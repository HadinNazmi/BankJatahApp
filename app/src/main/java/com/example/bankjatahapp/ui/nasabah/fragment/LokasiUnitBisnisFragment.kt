...
class LokasiUnitBisnisFragment : Fragment() {

    private var _binding: FragmentLokasiUnitBisnisBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLokasiUnitBisnisBinding.inflate(inflater, container, false)
        return binding.root
    }
